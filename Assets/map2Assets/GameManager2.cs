...
public class GameManager2 : MonoBehaviour
{
    ...
    void SpawnCharacters()
    {
        ...
        List<CharacterLogic2> allChars = new List<CharacterLogic2>();
        ...
        for (int i = 0; i < totalCharacters; i++)
        {
            ...
            // 引用修改点：CharacterLogic -> CharacterLogic2
            CharacterLogic2 logic = go.GetComponent<CharacterLogic2>();
            if (logic != null)
            {
        ...
        if (allChars.Count >= 2)
        {
            ...
            // 引用修改点：CharacterLogic -> CharacterLogic2
            allChars[p1].currentRole = CharacterLogic2.Role.Player1;
            allChars[p2].currentRole = CharacterLogic2.Role.Player2;
